...
models:
  - gpt-5-codex
  - gpt-5
priceNote_zh: 订阅制 / 30 天：Codex Mini $10 · Codex Lite $20 · Codex Pro $60（推荐）
priceNote_en: Subscription / 30 days · Codex Mini $10 · Codex Lite $20 · Codex Pro $60 (recommended)
...
| 套餐 | 价格 / 30 天 | 日配额 | 月 / 总配额 | 定位 |
|---|---|---|---|---|
| Codex Mini | $10 | $15 | $450 | 重度调用 / 企业商用 |
| Codex Lite | $20 | $30 | $900 | 个人开发 / 频繁调试 |
| Codex Pro（推荐） | $60 | $90 | $2700 | 团队协作 / 轻量商用 |
