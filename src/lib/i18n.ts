...
export const ui = {
  'zh-CN': {
    ...
    brand_r: '点评',
    site_name: '中转站点评',
    site_tagline: 'AI API 中转站点评',
    meta_title_home: '中转站点评 — AI API 中转站模型、价格、活动一览',
    meta_desc_home: 'AI API 中转站点评：模型清单、价格、活动一目了然，覆盖 GPT-5 / Claude / Gemini 等主流模型转发服务，由用户评分与点评。',
  ...
  en: {
    ...
    site_tagline: 'AI API relay station reviews',
    meta_title_home: 'Relay Reviews — AI API Relay Models, Pricing & Promotions',
    meta_desc_home: 'User reviews and ratings of AI API relay providers. Compare models, pricing and promotions across GPT-5, Claude, Gemini and more — judgment by users, not us.',
